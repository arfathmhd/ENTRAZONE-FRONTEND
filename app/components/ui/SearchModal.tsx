...
function SearchModal({isOpen,setIsOpen}:{isOpen:boolean,setIsOpen:(open: boolean) => void}) {
      const recentSearches = ["Introduction to Mathematics", "Chemistry basics", "Biology fundamentals"]
